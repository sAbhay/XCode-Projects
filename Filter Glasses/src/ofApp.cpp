...
void ofApp::takeScreenshot()
{
    ...
    string imgName = "Screenshot on " + to_string(ofGetDay()) + ", " + to_string(ofGetMonth()) + ", " + to_string(ofGetYear()) + " at " + to_string(ofGetHours()) + "-" + to_string(ofGetMinutes()) + "-" + to_string(ofGetSeconds()) + ".png";
